...
public interface TransportOrderDomainService extends com.baomidou.mybatisplus.extension.service.IService<TransportOrderEntity> {
     ...
     * @return 分页结果
     */
    TableDataInfo<TransportOrderEntity> selectPageTransportOrder(TransportOrderEntity transportOrder, PageQuery pageQuery);
     ...
     * @return 实体
     */
    TransportOrderEntity getByOrderNo(String orderNo);
     ...
     * @return 创建结果
     */
    boolean createTransportOrder(TransportOrderEntity transportOrder);
     ...
     * @return 创建结果
     */
    boolean batchCreateTransportOrder(List<TransportOrderEntity> transportOrders);
