...
-- 演示品牌
-- ---------------------------------------------------------------
INSERT INTO brand (id, name, code, description, enabled, sort, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 演示车辆类型（依赖 brand）
-- ---------------------------------------------------------------
INSERT INTO vehicle_type (id, brand_id, name, length, width, height, max_velocity, max_reverse_velocity, energy_level, allowed_orders, allowed_peripheral_operations, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 演示车辆（2台仿真车）
-- ---------------------------------------------------------------
INSERT INTO vehicle (id, name, vehicle_type_id, state, integration_level, energy_level, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 演示工厂模型
-- ---------------------------------------------------------------
INSERT INTO factory_model (id, factory_id, name, description, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 演示导航地图（一楼）
-- ---------------------------------------------------------------
INSERT INTO navigation_map (id, factory_model_id, map_id, name, floor_number, status, map_version, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 演示图层组和图层
-- ---------------------------------------------------------------
INSERT INTO factory_layer_group (id, navigation_map_id, name, visible, ordinal, create_by, create_time, update_by, update_time, del_flag)
VALUES
    (1, 1, '默认图层组', 1, 1, 1, NOW(), 1, NOW(), '0')
ON DUPLICATE KEY UPDATE name = VALUES(name);

INSERT INTO factory_layer (id, navigation_map_id, layer_group_id, name, visible, ordinal, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- 坐标单位：mm
-- ---------------------------------------------------------------
INSERT INTO point (navigation_map_id, point_id, name, x_position, y_position, z_position, pose_theta, type, layer_id, create_by, create_time, update_by, update_time, del_flag)
VALUES
...
-- ---------------------------------------------------------------
INSERT INTO path (navigation_map_id, path_id, name, source_point_id, dest_point_id, length, max_velocity, max_reverse_velocity, locked, layer_id, create_by, create_time, update_by, update_time, del_flag)
VALUES
    -- 上排正向
...
-- 演示位置类型和位置（货架 + 充电桩）
-- ---------------------------------------------------------------
INSERT INTO location_type (id, name, allowed_actions, create_by, create_time, update_by, update_time, del_flag)
VALUES
    (1, '货架', '["LOAD", "UNLOAD"]', 1, NOW(), 1, NOW(), '0'),
    (2, '充电桩', '["CHARGE"]',        1, NOW(), 1, NOW(), '0')
ON DUPLICATE KEY UPDATE name = VALUES(name);

INSERT INTO location (navigation_map_id, location_id, name, location_type_id, linked_point_id, x_position, y_position, z_position, layer_id, create_by, create_time, update_by, update_time, del_flag)
VALUES
