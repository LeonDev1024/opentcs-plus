...
public class MapApplicationService {
    ...
    private final RouteTopologyPort routeTopology;
    private final RoutePlannerApi routePlannerApi;
    ...
    public void registerPoint(PointDTO pointDTO) {
        ...
        routeTopology.registerPoint(point);
    ...
    public void unregisterPoint(String pointId) {
        routeTopology.unregisterPoint(pointId);
    ...
    public void registerPath(PathDTO pathDTO) {
        ...
        routeTopology.registerPath(path);
    ...
    public void unregisterPath(String pathId) {
        routeTopology.unregisterPath(pathId);
    ...
    public RouteDTO findRoute(String sourcePointId, String destPointId) {
        Optional<RouteDTO> route = routePlannerApi.findRoute(sourcePointId, destPointId);
